    ...
    return (
        <>
            <div className={styles.home22}>
                ...
                {/* <b className={styles.ourLeaders}>OUR <span className="founding" >FOUNDING </span></b> */}
                ...
                <div className={styles.ceoCfoParent}>
                    ...
                    <div className={styles.ceoCfo}>{`Co-Founder`}</div>
                ...
                <div className={styles.ctoParent}>
                    <div className={styles.cto}>Co-Founder</div>
